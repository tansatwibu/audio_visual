...
#             net.load_state_dict(torch.load(weights, map_location=torch.device('cuda:1')))
#         return net
...
#             pretrained_state = torch.load(weights, map_location=torch.device('cuda:1'))
...
import torchvision
import torch.nn as nn
from .networks import Resnet18, AudioVisual5layerUNet, AudioPose7layerUNet, AudioVisualPose7layerUNet, AudioVisual7layerUNet, weights_init
