...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoints_dir', type=str, default='/media/data4/home/lanlt/Datle/co-separation_dat_copy/checkpoint_14_4/', help='models are saved here')
